...
describe("CAT Relay V32b", () => {
  it("génère des IDs distincts entre instances même au même instant", () => {
    const first = createCatCommandId(1_700_000_000_000, "aaaaaaaa-1111-1111-1111-111111111111");
    const second = createCatCommandId(1_700_000_000_000, "bbbbbbbb-2222-2222-2222-222222222222");
